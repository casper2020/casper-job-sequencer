...
*/
#pragma once
#ifndef CASPER_JOB_RECOVERY_H_
#define CASPER_JOB_RECOVERY_H_
...
namespace casper
{
    ...
    namespace job
    {
        ...
        class Recovery final : public Sequencer
        {
        ...
        public: // Constructor(s) / Destructor
            ...
            Recovery () = delete;
            Recovery (const ev::Loggable::Data& a_loggable_data, const cc::job::easy::Job::Config& a_config);
            virtual ~Recovery ();
        ...
        }; // end of class 'Recovery'
              
    } // end of namespace 'job'

} // end of namespace 'casper'

#endif // CASPER_JOB_RECOVERY_H_
